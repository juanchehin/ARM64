/* Chehin Juan Martin - Cuenta de 0 a 999
-------------------------------------------

- Con el boton 3 (empezando desde la derecha) se resetea a 000

- Con el boton 2 empieza la cuenta y reanuda la cuenta

- Con el boton 1 pone en pausa la cuenta

- Cuando llega a 999 vuelve a 000
...
reset:
 ...
 refrescar:
    ...
    ANDS  R1,R0,#(1 << BOTON2_BIT)  // Si la tecla esta apretada
    MVN r7,r7
    ANDS r7,r1
    IT    NE
    ...
    ANDS  R1,R0,#(1 << BOTON3_BIT)//   Si la tecla esta apretada
    MVN r5,r5
    ANDS r5,r1
    IT    NE
